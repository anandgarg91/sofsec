...
class plc2:
	...
	def __init__(self, HMI):
		self.TON_FIT102_P1_TM	= TONR(3)
		self.TON_FIT102_P2_TM	= TONR(3)
		self.TON_FIT102_P3_TM	= TONR(3)
		self.TON_FIT102_P4_TM	= TONR(3)
		self.TON_FIT102_P5_TM	= TONR(3)
		self.TON_FIT102_P6_TM	= TONR(3)
		...
		self.MV201_FB = MV_FBD(15,15,HMI.MV201)
...
#		print "LSLL203_FB Initialized"
		self.P201_FB  = PMP_FBD(3,3,HMI.P201)
#		print "P201_FB Initialized"
		self.P202_FB  = PMP_FBD(3,3,HMI.P202)
#		print "P202_FB Initialized"
		self.P203_FB  = PMP_FBD(3,3,HMI.P203)
#		print "P203_FB Initialized"
		self.P204_FB  = PMP_FBD(3,3,HMI.P204)
#		print "P204_FB Initialized"
		self.P205_FB  = PMP_FBD(3,3,HMI.P205)
#		print "P205_FB Initialized"
		self.P206_FB  = PMP_FBD(3,3,HMI.P206)
#		print "P206_FB Initialized"
		self.P207_FB  = PMP_FBD(3,3,HMI.P207)
#		print "P207_FB Initialized"
		self.P208_FB  = PMP_FBD(3,3,HMI.P208)
...
#		print "P_NAOCL_FAC_DUTY_FB Initialized"
		self.FIT201_FB = FIT_FBD(-5,31208,3277,16383,4.0,0.0,HMI.FIT201)
#		print "FIT201_FB Initialized"
		self.AIT201_FB = AIN_FBD(0,31208,3277,16383,1000,0.0,HMI.AIT201) 
#		print "AIT201_FB Initialized"
		self.AIT202_FB = AIN_FBD(0,31208,3277,16383,12,2,HMI.AIT202)
#		print "AIT202_FB Initialized"
		self.AIT203_FB = AIN_FBD(0,31208,3277,16383,800,0.0,HMI.AIT203)
#		print "AIT203_FB Initialized"
#		print "All Phase 2 Function Blocks Initialized Successfully\n"
		print "	PLC2 Started\n"


	def Pre_Main_UF_Feed_Dosing(self,IO_DI_WIFI,IO,HMI,Sec_P,Min_P,Hrs_P):
...
#	def Pre_Condition(self,IO_DI_WIFI.RIO2, IO.LS201,IO.LS202,IO.LSL203,IO.LSLL203,IO.P201, IO_PMP_UV,IO.P202 ,IO.P203 ,IO.P204,IO.P205,IO.P206 ,IO.P207,IO.P208 ,IO.FIT201,IO.AIT201 ,IO.AIT202,IO.AIT203,HMI.PLANT,HMI.P2, HMI.MV201, HMI.LS201, HMI.LS202, HMI.LSL203,HMI.LSLL203, HMI.P201, HMI.P202, HMI.P203, HMI.P204, HMI.P205, HMI.P206, HMI.P207, HMI.P208,HMI.P_NACL_DUTY, HMI.P_HCL_DUTY, HMI.P_NAOCL_FAC_DUTY, HMI.FIT201, HMI.AIT201, HMI.AIT202, HMI.AIT203,HMI.MV301):
	#def Dosing_UF_Feed(self,IO_DI_WIFI.RIO2, IO.MV201,IO.LS201,IO.LS202,IO.LSL203,IO.LSLL203, IO.P201, IO_PMP_UV,IO.P202 ,IO.P203 ,IO.P204,IO.P205,IO.P206 ,IO.P207,IO.P208 ,IO.FIT201,IO.AIT201 ,IO.AIT202,IO.AIT203,HMI.PLANT,HMI.P2, HMI.MV201, HMI.LS201, HMI.LS202, HMI.LSL203,HMI.LSLL203, HMI.P201, HMI.P202, HMI.P203, HMI.P204, HMI.P205, HMI.P206, HMI.P207, HMI.P208,HMI.P_NACL_DUTY, HMI.P_HCL_DUTY, HMI.P_NAOCL_FAC_DUTY, HMI.FIT201, HMI.AIT201, HMI.AIT202, HMI.AIT203,Min_P,Sec_P):
		...
		self.P201_FB.PMP_FBD(self.P_NACL_DUTY_FB.Start_Pmp1, IO.P201, HMI.P201,Min_P)
		self.P202_FB.PMP_FBD(self.P_NACL_DUTY_FB.Start_Pmp2, IO.P202, HMI.P202,Min_P)
		self.P203_FB.PMP_FBD(self.P_HCL_DUTY_FB.Start_Pmp1, IO.P203, HMI.P203,Min_P)
		self.P204_FB.PMP_FBD(self.P_HCL_DUTY_FB.Start_Pmp2, IO.P204, HMI.P204,Min_P)
		self.P205_FB.PMP_FBD(self.P_NAOCL_FAC_DUTY_FB.Start_Pmp1,IO.P205, HMI.P205,Min_P )
		self.P206_FB.PMP_FBD(self.P_NAOCL_FAC_DUTY_FB.Start_Pmp2,IO.P206, HMI.P206,Min_P)
		...
		self.FIT201_FB.FIT_FBD(IO_DI_WIFI.RIO2,self.Mid_FIT201_Tot_Enb, IO.FIT201, HMI.FIT201, Sec_P)
		self.AIT201_FB.AIN_FBD(IO_DI_WIFI.RIO2, IO.AIT201,HMI.AIT201)
		self.AIT202_FB.AIN_FBD(IO_DI_WIFI.RIO2, IO.AIT202,HMI.AIT202)
		self.AIT203_FB.AIN_FBD(IO_DI_WIFI.RIO2, IO.AIT203,HMI.AIT203)
