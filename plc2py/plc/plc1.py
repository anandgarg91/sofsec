...
#		print "P_RAW_WATER_DUTY_FB Initialized"
		self.P101_FB = PMP_FBD(3,3,HMI.P101)
#		print "P101_FB Initialized" 	
		self.P102_FB = PMP_FBD(3,3,HMI.P102)
#		print "P102_FB Initialized" 	
		self.LIT101_FB = AIN_FBD(0,31208,3277,16383,1225,0.0,HMI.LIT101)
#		print "LIT101_FB Initialized"
		self.MV101_FB = MV_FBD(15,15,HMI.MV101)
#		print "MV101_FB Initialized"
		self.FIT101_FB = FIT_FBD(-15, 31208, 3277,16383,10,0.0,HMI.FIT101)
...
#		print "All Phase 1 Function Blocks Initialized Successufully\n"
		...
		self.Mid_MV101_AutoInp = 1 #Initialization
		self.Mid_FIT101_Flow_Hty = 1
		self.Mid_P_RAW_WATER_DUTY_AutoInp = 1
		self.Min_Test = 0
		print "	PLC1 started\n" 
	def Pre_Main_Raw_Water(self,IO_DI_WIFI,IO,HMI,Sec_P,Min_P,Hrs_P):
		...
		HMI.PLANT.Ready = HMI.P1.Permissive_On and HMI.P2.Permissive_On and HMI.P3.Permissive_On and HMI.P4.Permissive_On and HMI.P5.Permissive_On and HMI.P6.Permissive_On  
		self.FIT101_Tot_Enb = (HMI.MV101.Status == 2)
		self.TON_FIT102_P1_TM = TONR(10)		
		self.TON_FIT102_P2_TM = TONR(10)
...
#	def Raw_Water(self,Min_P,Sec_P):
		self.LIT101_FB.AIN_FBD(IO_DI_WIFI.RIO1, IO.LIT101,HMI.LIT101)
		self.MV101_FB.MV_FBD(self.Mid_MV101_AutoInp, IO.MV101, HMI.MV101)
		self.FIT101_FB.FIT_FBD(IO_DI_WIFI.RIO1, self.Mid_FIT101_Flow_Hty, IO.FIT101, HMI.FIT101, Sec_P)
		self.P_RAW_WATER_DUTY_FB.Duty2_FBD(self.Mid_P_RAW_WATER_DUTY_AutoInp, HMI.P101, HMI.P102, HMI.P_RAW_WATER_DUTY)
		self.P101_FB.PMP_FBD(self.P_RAW_WATER_DUTY_FB.Start_Pmp1, IO.P101, HMI.P101, Min_P)
		self.P102_FB.PMP_FBD(self.P_RAW_WATER_DUTY_FB.Start_Pmp2, IO.P102, HMI.P102, Min_P)
