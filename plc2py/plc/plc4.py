...
class plc4:
	...
	def __init__(self,HMI):
		...
		self.TON_FIT401_TM = TONR(6)
		self.TON_FIT401_P1_TM = TONR(6)
		self.TON_FIT401_P2_TM = TONR(6)
		self.Mid_P_RO_FEED_DUTY_AutoInp = 0
		self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = 0
		
		self.LIT401_FB = AIN_FBD(0,31208, 3277, 16383, 1200, 0.0, HMI.LIT401)
		self.P_RO_FEED_DUTY_FB = Duty2_FBD()
		self.P401_FB = PMP_FBD(3,3, HMI.P401)
		self.P402_FB = PMP_FBD(3,3, HMI.P402)
		self.AIT401_FB = AIN_FBD(0,31208,3277,16383,150,0.0,HMI.AIT401)
		self.FIT401_FB = FIT_FBD(-5,31208, 3277, 16383, 4, 0.0, HMI.FIT401)
		self.UV401_FB = UV_FBD(3,3,HMI.UV401)
		self.AIT402_FB = AIN_FBD(0, 31208, 3277, 16383, 800, 0.0, HMI.AIT402)
		self.LS401_FB = SWITCH_FBD(HMI.LS401)

		self.P_NAHSO3_ORP_DUTY_FB = Duty2_FBD()
		self.P403_FB = PMP_FBD(3,3, HMI.P403)
		self.P404_FB = PMP_FBD(3,3, HMI.P404)
		print "	PLC4 Started\n"

	def Pre_Main_RO_Feed_Dosing(self, IO_DI_WIFI,IO,HMI,Sec_P,Min_P,Hrs_P):
...
# Main
		...
		if HMI.P4.State == 2:
			...
			if HMI.P_RO_FEED_DUTY.Pump_Running:
				HMI.P4.State=3
		...
		if HMI.P4.State == 5:
			...
			if not HMI.P_RO_FEED_DUTY.Pump_Running:			
				HMI.P4.State=6
...
# RO_Feed_Dosing
		self.LIT401_FB.AIN_FBD(IO_DI_WIFI.RIO4,IO.LIT401,HMI.LIT401)
		self.P_RO_FEED_DUTY_FB.Duty2_FBD(self.Mid_P_RO_FEED_DUTY_AutoInp, HMI.P401, HMI.P402, HMI.P_RO_FEED_DUTY)
		self.P401_FB.PMP_FBD(self.P_RO_FEED_DUTY_FB.Start_Pmp1,IO.P401,HMI.P401,Min_P)
		self.P402_FB.PMP_FBD(self.P_RO_FEED_DUTY_FB.Start_Pmp2,IO.P402,HMI.P402,Min_P)
		self.AIT401_FB.AIN_FBD(IO_DI_WIFI.RIO4,IO.AIT401,HMI.AIT401)
		self.FIT401_FB.FIT_FBD(IO_DI_WIFI.RIO4,self.Mid_FIT401_Tot_Enb,IO.FIT401, HMI.FIT401,Sec_P)
		self.AIT402_FB.AIN_FBD(IO_DI_WIFI.RIO4,IO.AIT402,HMI.AIT402)
		...
		self.P403_FB.PMP_FBD(self.P_NAHSO3_ORP_DUTY_FB.Start_Pmp1,IO.P403,HMI.P403,Min_P)
		self.P404_FB.PMP_FBD(self.P_NAHSO3_ORP_DUTY_FB.Start_Pmp2,IO.P404,HMI.P404,Min_P)
