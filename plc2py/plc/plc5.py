...
class plc5:
	...
	def __init__(self,HMI):
		...
		self.AIT501_FB = AIN_FBD(0,31208,3277,16383,12,2,HMI.AIT501)
		self.AIT502_FB = AIN_FBD(0,31208,3277,16383,800,0,HMI.AIT502)
		self.AIT503_FB = AIN_FBD(0,31208,3277,16383,1000,0.0,HMI.AIT503)
		self.AIT504_FB = AIN_FBD(0,31208,3277,16383,1200,0,HMI.AIT504)
		self.PIT501_FB = AIN_FBD(0,31208,3277,16383,500,0,HMI.PIT501)
		self.PIT502_FB = AIN_FBD(-5,31208,3277,16383,500,0,HMI.PIT502)
		self.PIT503_FB = AIN_FBD(0,31208,3277,16383,500,0,HMI.PIT503)
		self.FIT501_FB = FIT_FBD(0,31208,3277,16383,4.0,0.0,HMI.FIT501)
		self.FIT502_FB = FIT_FBD(-20,31208,3277,16383,4.0,0.0,HMI.FIT502)
		self.FIT503_FB = FIT_FBD(-35,31208,3277,16383,4.0,0.0,HMI.FIT503)
		self.FIT504_FB = FIT_FBD(-15,31208,3277,16383,2.0,0.0,HMI.FIT504)
		self.MV501_FB  = MV_FBD(15,15,HMI.MV501)
		self.MV502_FB  = MV_FBD(15,15,HMI.MV502)
		self.MV503_FB  = MV_FBD(15,15,HMI.MV503)
		self.MV504_FB  = MV_FBD(15,15,HMI.MV504)
		self.P501_FB   = VSD_FBD(20,20,HMI.P501)
		self.P502_FB   = VSD_FBD(20,20,HMI.P502)
		self.P_RO_HIGH_DUTY_FB = Duty2_FBD()

		print "	PLC5 Started\n"

	def Pre_Main_High_Pressure_RO(self,IO_DI_WIFI,IO,HMI,Sec_P,Min_P,Hrs_P ):
...
#Main
		...
		while switch(HMI.P5.State):
			...
			if case(8):
				...
				HMI.Cy_P5.MV503_TIMEOUT_TM		=0	
				HMI.Cy_P5.MV504_TIMEOUT_TM		=0
				if HMI.Cy_P5.MV501.Status==2 or self.Mid_NEXT:
					self.Mid_NEXT=0
					HMI.P5.State=9	
				break
			if case(9):
				...
				HMI.Cy_P5.MV503_TIMEOUT_TM		=0	
				HMI.Cy_P5.MV504_TIMEOUT_TM		=0
				if HMI.Cy_P5.MV503.Status==1 or self.Mid_NEXT:
					self.Mid_NEXT=0
					HMI.P5.State=10	
				break
			if case(10):
				...
				HMI.Cy_P5.MV503_TIMEOUT_TM		=0	
				HMI.Cy_P5.MV504_TIMEOUT_TM		=0
				if HMI.Cy_P5.MV502.Status==2 or self.Mid_NEXT:
					self.Mid_NEXT=0
					HMI.P5.State=11	
				break	
			if case(11):
				...
				HMI.Cy_P5.MV503_TIMEOUT_TM		=0	
				HMI.Cy_P5.MV504_TIMEOUT_TM		=0
				if HMI.Cy_P5.MV504.Status==1 or self.Mid_NEXT:
					self.Mid_NEXT=0
					HMI.P5.State=12	
				break	
			if case(12):
			...
			if case(15):
				...
				if HMI.Cy_P5.MV504.Status==2 or self.Mid_NEXT or HMI.Cy_P5.MV504_TIMEOUT_TM >120:
					self.Mid_NEXT=0
					HMI.P5.State=16			
				break	
			if case(16):
			...
			if case(18):
				...
				HMI.Cy_P5.MV503_TIMEOUT_TM		=0	
				HMI.Cy_P5.MV504_TIMEOUT_TM		=0
				if HMI.Cy_P5.MV501.Status==1 or self.Mid_NEXT or HMI.Cy_P5.MV501_TIMEOUT_TM >120 :
					self.Mid_NEXT=0
					HMI.P5.State=19			
				break
			if case(19):
			...
			if case(21):
				...
				if Sec_P:
					HMI.Cy_P5.MV503_TIMEOUT_TM= HMI.Cy_P5.MV503_TIMEOUT_TM+1
					HMI.Cy_P5.MV504_TIMEOUT_TM= HMI.Cy_P5.MV504_TIMEOUT_TM+1
				if HMI.Cy_P5.MV503.Status==1 and HMI.Cy_P5.MV504.Status==1 or self.Mid_NEXT or HMI.Cy_P5.MV503_TIMEOUT_TM >120 or HMI.Cy_P5.MV504_TIMEOUT_TM >120 :
					HMI.P5.State=1			
				break
			HMI.P5.State=1
			break
...
#	def High_Pressure_RO(self):
		self.AIT501_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.AIT501,HMI.AIT501)
		self.AIT502_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.AIT502,HMI.AIT502)
		self.AIT503_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.AIT503,HMI.AIT503)
		self.AIT504_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.AIT504,HMI.AIT504)
		self.PIT501_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.PIT501,HMI.PIT501)
		self.PIT502_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.PIT502,HMI.PIT502)
		self.PIT503_FB.AIN_FBD(IO_DI_WIFI.RIO5,IO.PIT503,HMI.PIT503)
		self.FIT501_FB.FIT_FBD(IO_DI_WIFI.RIO5,self.Mid_FIT501_Tot_Enb,IO.FIT501,HMI.FIT501,Sec_P)
		self.FIT502_FB.FIT_FBD(IO_DI_WIFI.RIO5,self.Mid_FIT502_Tot_Enb,IO.FIT502,HMI.FIT502,Sec_P)
		self.FIT503_FB.FIT_FBD(IO_DI_WIFI.RIO5,self.Mid_FIT503_Tot_Enb,IO.FIT503,HMI.FIT503,Sec_P)
		self.FIT504_FB.FIT_FBD(IO_DI_WIFI.RIO5,self.Mid_FIT504_Tot_Enb,IO.FIT504,HMI.FIT504,Sec_P)
		...
		self.P501_FB.VSD_FBD(self.P_RO_HIGH_DUTY_FB.Start_Pmp1,self.Mid_P50X_AutoSpeed, IO.P501_VSD_In, IO.P501_VSD_Out, IO.P501,HMI.P501, Min_P)
		self.P502_FB.VSD_FBD(self.P_RO_HIGH_DUTY_FB.Start_Pmp2,self.Mid_P50X_AutoSpeed, IO.P502_VSD_In, IO.P502_VSD_Out, IO.P502,HMI.P502, Min_P)
