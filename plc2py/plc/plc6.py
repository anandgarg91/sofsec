...
class plc6:
	...
	def __init__(self,HMI):
		self.Mid_P_PERMEATE_SR = 0
		self.Mid_P601_AutoInp = 0
		self.Mid_P602_AutoInp = 0
		self.Mid_P603_AutoInp = 0
#The below two lines need to be checked, where are they assigned in the RSLogix5000 code?
		self.Mid_P602_AutoInp = 0
		self.Mid_P603_AutoInp = 0
		...
		self.P601 = PMP_FBD(3,3,HMI.P601)
		self.P602 = PMP_FBD(3,3,HMI.P602)
		self.P603 = PMP_FBD(3,3,HMI.P603)
		print "	PLC6 Started\n"


	def Pre_Main_Product(self,IO_DI_WIFI,IO,HMI,Sec_P,Min_P,Hrs_P):
...
#Main
		...
		#!!!!!What's This? P6_P602_AutoInp.On is neighther from HMI or IO
		if HMI.P6.State == 1:
			self.Mid_P601_AutoInp	= 0 
			self.Mid_P602_AutoInp	= 0 
			self.Mid_P603_AutoInp	= 0
...
#the Above two lines are strange, the left and right hand side symnols are identical
		else:
			HMI.P6.State=1
...
#Product
		...
		self.P601.PMP_FBD(self.Mid_P601_AutoInp, IO.P601,HMI.P601,Min_P)
		self.P602.PMP_FBD(self.Mid_P602_AutoInp, IO.P602,HMI.P602,Min_P)
		self.P603.PMP_FBD(self.Mid_P603_AutoInp, IO.P603,HMI.P603,Min_P)
